module.exports.config = {
 ...
 hasPermssion: 0,
 credits: "Adnan",
 description: "Emoji দিলে কিউট/ফানি/গালি/মিম ভয়েস পাঠাবে 😍",
...
const emojiAudioMap = {
 ...
 "☠️": "https://files.catbox.moe/utl83s.mp3",
...
module.exports.handleEvent = async ({ api, event }) => {
 ...
 writer.on('error', () => {
 api.sendMessage("ইমুজি দিয়া লাভ নাই — যাই গিয়া মুড়ি খাও 🤭", threadID, messageID);
 });
