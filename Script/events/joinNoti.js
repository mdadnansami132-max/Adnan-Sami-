...
module.exports.run = async function({ api, event }) {
  ...
  const botName = global.config.BOTNAME || "MURGI CHOR🐔☢️";

 
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    await api.changeNickname(`[ ${botPrefix} ] • ${botName}`, threadID, api.getCurrentUserID());

    api.sendMessage("মুরগির মাকে E=mc2 থিওরি অফ রিলেটিভিটি স্টাইলে আলোর গতিতে চু*দব", threadID, () => {
      ...
      const messageBody = `╭•┄┅═══❁🌺❁═══┅┄•╮
     চু*দার রাজ্যে স্বাগতম
╰•┄┅═══❁🌺❁═══┅┄•╯

গ্রুপে যে এড দিছে তার বউ এর
ভু*দায় গদগদ গদগদ
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন ADNAN SAMI কে নক করতে পারেন ★
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫:https://m.facebook.com/adnansamy.adnansamy.54/
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩:0562043993

❖⋆═══════════════════════⋆❖
          𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ ADNAN SAMI`;
...
➤ আশা করি আপনি এখানে চু*দনামি করে 
আড্ডা দিতে ভালোবাসবেন।
➤ সবার সাথে মিলেমিশে থাকবেন
➤ উস্কানিমূলক কথা বা খারাপ ব্যবহার করলে চু*দে মে*রে ফেলবো
➤ গ্রুপ এডমিনের কথা শুনবেন ও রুলস চু*দার দরকার নাই
